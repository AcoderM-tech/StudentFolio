...
# ── Media fayllar: Umumiy sozlamalar ────────────────────────────────────────
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Supabase S3 muhit o'zgaruvchilari
...
# Diqqat: AWS_S3_ENDPOINT_URL o'rniga to'g'ridan-to'g'ri unga mos parametrlar
AWS_S3_ENDPOINT_URL = os.environ.get('SUPABASE_S3_ENDPOINT')
AWS_S3_CUSTOM_DOMAIN = None  # Supabase havolalari buzilib ketmasligi uchun

# Majburlab S3 storageni ishlatamiz
